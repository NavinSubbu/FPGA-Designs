...
entity system_v_tpg_0_0_tpgForeground is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of system_v_tpg_0_0_tpgForeground is 
...
attribute shreg_extract : string;
    ...
    signal height_val5_c_blk_n : STD_LOGIC;
    signal width_val10_c_blk_n : STD_LOGIC;
    signal colorFormat_val27_c_blk_n : STD_LOGIC;
    signal boxColorB_val_read_reg_401 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal boxColorG_val_read_reg_406 : STD_LOGIC_VECTOR (9 downto 0);
    signal boxColorR_val_read_reg_411 : STD_LOGIC_VECTOR (9 downto 0);
    signal boxSize_val_read_reg_416 : STD_LOGIC_VECTOR (15 downto 0);
    signal crossHairY_val_read_reg_423 : STD_LOGIC_VECTOR (15 downto 0);
    signal crossHairX_val_read_reg_428 : STD_LOGIC_VECTOR (15 downto 0);
    signal colorFormat_val_read_reg_433 : STD_LOGIC_VECTOR (7 downto 0);
    signal motionSpeed_val_read_reg_439 : STD_LOGIC_VECTOR (7 downto 0);
    signal maskId_val_read_reg_445 : STD_LOGIC_VECTOR (7 downto 0);
    signal patternId_val_read_reg_450 : STD_LOGIC_VECTOR (7 downto 0);
    signal loopWidth_reg_455 : STD_LOGIC_VECTOR (15 downto 0);
    signal loopHeight_reg_461 : STD_LOGIC_VECTOR (15 downto 0);
    signal empty_122_fu_271_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_122_reg_467 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_reg_482 : STD_LOGIC_VECTOR (0 downto 0);
    signal cmp31_i_fu_330_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal cmp31_i_reg_487 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal conv2_i_i_i129_fu_335_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal conv2_i_i_i129_reg_492 : STD_LOGIC_VECTOR (9 downto 0);
    signal hMax_fu_343_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal hMax_reg_497 : STD_LOGIC_VECTOR (15 downto 0);
    signal vMax_fu_347_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal vMax_reg_502 : STD_LOGIC_VECTOR (15 downto 0);
    signal shl_i_fu_351_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal shl_i_reg_507 : STD_LOGIC_VECTOR (8 downto 0);
    signal y_1_reg_512 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal cmp2_i_fu_372_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal cmp2_i_reg_520 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal grp_tpgForeground_Pipeline_VITIS_LOOP_774_2_fu_220_ovrlayYUV_din : STD_LOGIC_VECTOR (29 downto 0);
    signal grp_tpgForeground_Pipeline_VITIS_LOOP_774_2_fu_220_ovrlayYUV_write : STD_LOGIC;
    signal grp_tpgForeground_Pipeline_VITIS_LOOP_774_2_fu_220_boxHCoord_loc_1_out_o : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_tpgForeground_Pipeline_VITIS_LOOP_774_2_fu_220_boxHCoord_loc_1_out_o_ap_vld : STD_LOGIC;
    signal grp_tpgForeground_Pipeline_VITIS_LOOP_774_2_fu_220_boxVCoord_loc_1_out_o : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_tpgForeground_Pipeline_VITIS_LOOP_774_2_fu_220_boxVCoord_loc_1_out_o_ap_vld : STD_LOGIC;
    ...
    signal y_2_fu_366_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal icmp_ln772_fu_361_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_5_fu_291_p4 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    component system_v_tpg_0_0_tpgForeground_Pipeline_VITIS_LOOP_774_2 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_tpgForeground_Pipeline_VITIS_LOOP_774_2_fu_220 : component system_v_tpg_0_0_tpgForeground_Pipeline_VITIS_LOOP_774_2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((icmp_ln772_fu_361_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((grp_tpgForeground_Pipeline_VITIS_LOOP_774_2_fu_220_boxHCoord_loc_1_out_o_ap_vld = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((grp_tpgForeground_Pipeline_VITIS_LOOP_774_2_fu_220_boxVCoord_loc_1_out_o_ap_vld = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((icmp_ln772_fu_361_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then
                ...
                tmp_4_reg_477 <= maskId_val_dout(2 downto 2);
                tmp_reg_472 <= maskId_val_dout(1 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                cmp31_i_reg_487 <= cmp31_i_fu_330_p2;
                    conv2_i_i_i129_reg_492(8 downto 6) <= conv2_i_i_i129_fu_335_p3(8 downto 6);
                hMax_reg_497 <= hMax_fu_343_p2;
                    shl_i_reg_507(8 downto 1) <= shl_i_fu_351_p3(8 downto 1);
                vMax_reg_502 <= vMax_fu_347_p2;
            end if;
        end if;
    end process;
    conv2_i_i_i129_reg_492(5 downto 0) <= "000000";
    conv2_i_i_i129_reg_492(9) <= '1';
    shl_i_reg_507(0) <= '0';

    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state1, ap_block_state1, ap_CS_fsm_state3, grp_tpgForeground_Pipeline_VITIS_LOOP_774_2_fu_220_ap_done, ap_CS_fsm_state5, icmp_ln772_fu_361_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((icmp_ln772_fu_361_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
    ...
    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, height_val_empty_n, width_val_empty_n, patternId_val_empty_n, maskId_val_empty_n, colorFormat_val_empty_n, crossHairX_val_empty_n, crossHairY_val_empty_n, boxSize_val_empty_n, boxColorR_val_empty_n, boxColorG_val_empty_n, boxColorB_val_empty_n, motionSpeed_val_empty_n, height_val5_c_full_n, width_val10_c_full_n, colorFormat_val27_c_full_n)
    begin
                ap_block_state1 <= ((boxColorB_val_empty_n = ap_const_logic_0) or (boxColorG_val_empty_n = ap_const_logic_0) or (boxColorR_val_empty_n = ap_const_logic_0) or (boxSize_val_empty_n = ap_const_logic_0) or (crossHairY_val_empty_n = ap_const_logic_0) or (crossHairX_val_empty_n = ap_const_logic_0) or (colorFormat_val_empty_n = ap_const_logic_0) or (maskId_val_empty_n = ap_const_logic_0) or (patternId_val_empty_n = ap_const_logic_0) or (width_val_empty_n = ap_const_logic_0) or (height_val_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (colorFormat_val27_c_full_n = ap_const_logic_0) or (width_val10_c_full_n = ap_const_logic_0) or (height_val5_c_full_n = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (motionSpeed_val_empty_n = ap_const_logic_0));
    end process;


    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state3, icmp_ln772_fu_361_p2)
    begin
        if (((icmp_ln772_fu_361_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state3, icmp_ln772_fu_361_p2)
    begin
        if (((icmp_ln772_fu_361_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    cmp2_i_fu_372_p2 <= "1" when (y_fu_114 = crossHairY_val_read_reg_423) else "0";
    cmp31_i_fu_330_p2 <= "1" when (colorFormat_val_read_reg_433 = ap_const_lv8_0) else "0";

    colorFormat_val27_c_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, colorFormat_val27_c_full_n)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            colorFormat_val27_c_blk_n <= colorFormat_val27_c_full_n;
        else 
            colorFormat_val27_c_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    colorFormat_val27_c_din <= colorFormat_val_dout;

    colorFormat_val27_c_write_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then 
            colorFormat_val27_c_write <= ap_const_logic_1;
        else 
            colorFormat_val27_c_write <= ap_const_logic_0;
        end if; 
    end process;
    ...
    conv2_i_i_i129_fu_335_p3 <= 
        ap_const_lv10_3C0 when (cmp31_i_fu_330_p2(0) = '1') else 
        ap_const_lv10_200;
    ...
    empty_122_fu_271_p1 <= maskId_val_dout(1 - 1 downto 0);
    ...
    hMax_fu_343_p2 <= std_logic_vector(unsigned(loopWidth_reg_455) - unsigned(boxSize_val_read_reg_416));

    height_val5_c_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, height_val5_c_full_n)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            height_val5_c_blk_n <= height_val5_c_full_n;
        else 
            height_val5_c_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    height_val5_c_din <= height_val_dout(12 - 1 downto 0);

    height_val5_c_write_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then 
            height_val5_c_write <= ap_const_logic_1;
        else 
            height_val5_c_write <= ap_const_logic_0;
        end if; 
    end process;
    ...
    icmp_fu_301_p2 <= "0" when (tmp_5_fu_291_p4 = ap_const_lv7_0) else "1";
    icmp_ln772_fu_361_p2 <= "1" when (y_fu_114 = loopHeight_reg_461) else "0";
    ...
    shl_i_fu_351_p3 <= (motionSpeed_val_read_reg_439 & ap_const_lv1_0);
    tmp_5_fu_291_p4 <= colorFormat_val_dout(7 downto 1);
    vMax_fu_347_p2 <= std_logic_vector(unsigned(loopHeight_reg_461) - unsigned(boxSize_val_read_reg_416));

    width_val10_c_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, width_val10_c_full_n)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            width_val10_c_blk_n <= width_val10_c_full_n;
        else 
            width_val10_c_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    width_val10_c_din <= width_val_dout(13 - 1 downto 0);

    width_val10_c_write_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then 
            width_val10_c_write <= ap_const_logic_1;
        else 
            width_val10_c_write <= ap_const_logic_0;
        end if; 
    end process;
    ...
    y_2_fu_366_p2 <= std_logic_vector(unsigned(y_fu_114) + unsigned(ap_const_lv16_1));
end behav;
