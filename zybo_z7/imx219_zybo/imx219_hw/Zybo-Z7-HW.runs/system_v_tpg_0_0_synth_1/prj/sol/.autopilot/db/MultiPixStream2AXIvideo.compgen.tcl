...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { ovrlayYUV_dout { I 30 vector } ovrlayYUV_empty_n { I 1 bit } ovrlayYUV_read { O 1 bit } ovrlayYUV_num_data_valid { I 5 vector } ovrlayYUV_fifo_cap { I 5 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { height_val5_dout { I 12 vector } height_val5_empty_n { I 1 bit } height_val5_read { O 1 bit } height_val5_num_data_valid { I 3 vector } height_val5_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { width_val10_dout { I 13 vector } width_val10_empty_n { I 1 bit } width_val10_read { O 1 bit } width_val10_num_data_valid { I 3 vector } width_val10_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { colorFormat_val27_dout { I 8 vector } colorFormat_val27_empty_n { I 1 bit } colorFormat_val27_read { O 1 bit } colorFormat_val27_num_data_valid { I 3 vector } colorFormat_val27_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { fid_in_val12_dout { I 1 vector } fid_in_val12_empty_n { I 1 bit } fid_in_val12_read { O 1 bit } fid_in_val12_num_data_valid { I 4 vector } fid_in_val12_fifo_cap { I 4 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { field_id_val11_dout { I 16 vector } field_id_val11_empty_n { I 1 bit } field_id_val11_read { O 1 bit } field_id_val11_num_data_valid { I 4 vector } field_id_val11_fifo_cap { I 4 vector } } \
} "
}
