...
attribute shreg_extract : string;
    ...
    signal cmp10252_i_fu_267_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal cmp10252_i_reg_449 : STD_LOGIC_VECTOR (0 downto 0);
    signal xor_ln216_fu_273_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal xor_ln216_reg_454 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln216_fu_297_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln216_reg_465 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal select_ln216_fu_351_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln216_reg_476 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal grp_reg_unsigned_short_s_fu_216_d : STD_LOGIC_VECTOR (11 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal grp_reg_unsigned_short_s_fu_222_ap_start : STD_LOGIC;
    signal grp_reg_unsigned_short_s_fu_222_ap_done : STD_LOGIC;
    signal grp_reg_unsigned_short_s_fu_222_ap_idle : STD_LOGIC;
    signal grp_reg_unsigned_short_s_fu_222_ap_ready : STD_LOGIC;
    signal grp_reg_unsigned_short_s_fu_222_ap_ce : STD_LOGIC;
    signal grp_reg_unsigned_short_s_fu_222_d : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal icmp_ln188_fu_282_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal grp_reg_unsigned_short_s_fu_222_ap_start_reg : STD_LOGIC := '0';
    signal i_fu_78 : STD_LOGIC_VECTOR (11 downto 0) := "000000000000";
    signal i_5_fu_287_p2 : STD_LOGIC_VECTOR (11 downto 0);
...
begin
    grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start_fu_132 : component system_v_gamma_lut_0_0_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_152 : component system_v_gamma_lut_0_0_AXIvideo2MultiPixStream_Pipeline_loop_width
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol_fu_180 : component system_v_gamma_lut_0_0_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_reg_unsigned_short_s_fu_216 : component system_v_gamma_lut_0_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_reg_unsigned_short_s_fu_222 : component system_v_gamma_lut_0_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state5) and (icmp_ln188_fu_282_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_logic_1 = ap_CS_fsm_state5) and (icmp_ln188_fu_282_p2 = ap_const_lv1_0))) then 
    ...
    grp_reg_unsigned_short_s_fu_222_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_reg_unsigned_short_s_fu_222_ap_start_reg <= ap_const_logic_0;
            else
                if (((ap_const_logic_1 = ap_NS_fsm_state3) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
                    grp_reg_unsigned_short_s_fu_222_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_reg_unsigned_short_s_fu_222_ap_ready = ap_const_logic_1)) then 
                    grp_reg_unsigned_short_s_fu_222_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state8) and (grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol_fu_180_axi_data_4_out_ap_vld = ap_const_logic_1))) then 
                axi_data_2_fu_74 <= grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol_fu_180_axi_data_4_out;
            elsif (((grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start_fu_132_axi_data_out_ap_vld = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_logic_1 = ap_CS_fsm_state5) and (icmp_ln188_fu_282_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state8) and (grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol_fu_180_axi_last_4_out_ap_vld = ap_const_logic_1))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state5, grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start_fu_132_ap_done, grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_152_ap_done, grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol_fu_180_ap_done, ap_CS_fsm_state3, icmp_ln188_fu_282_p2, ap_CS_fsm_state6, ap_CS_fsm_state8, ap_block_state1)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state5 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state5) and (icmp_ln188_fu_282_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state6;
                end if;
            when ap_ST_fsm_state6 => 
                if (((grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_152_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state6))) then
            ...
            when ap_ST_fsm_state8 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state8) and (grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol_fu_180_ap_done = ap_const_logic_1))) then
    ...
    and_ln216_fu_297_p2 <= (xor_ln216_reg_454 and sof_reg_110);
    ...
    ap_ST_fsm_state8_blk_assign_proc : process(grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol_fu_180_ap_done)
    begin
    ...
    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state5, icmp_ln188_fu_282_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state5) and (icmp_ln188_fu_282_p2 = ap_const_lv1_1))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state5, icmp_ln188_fu_282_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state5) and (icmp_ln188_fu_282_p2 = ap_const_lv1_1))) then 
    ...
    cmp10252_i_fu_267_p2 <= "0" when (grp_reg_unsigned_short_s_fu_222_ap_return = ap_const_lv12_0) else "1";
    ...
    grp_reg_unsigned_short_s_fu_216_d <= height(12 - 1 downto 0);

    grp_reg_unsigned_short_s_fu_222_ap_ce_assign_proc : process(ap_CS_fsm_state4, grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start_fu_132_ap_done, ap_CS_fsm_state3)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or ((grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start_fu_132_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3)))) then 
    ...
    grp_reg_unsigned_short_s_fu_222_ap_start <= grp_reg_unsigned_short_s_fu_222_ap_start_reg;
    grp_reg_unsigned_short_s_fu_222_d <= width(12 - 1 downto 0);
    i_5_fu_287_p2 <= std_logic_vector(unsigned(i_fu_78) + unsigned(ap_const_lv12_1));
    icmp_ln188_fu_282_p2 <= "1" when (i_fu_78 = rows_reg_436) else "0";
    imgRgb_din <= grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_152_imgRgb_din;
    imgRgb_write <= grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_152_imgRgb_write;
    s_axis_video_TREADY <= regslice_both_s_axis_video_V_data_V_U_ack_in;

    s_axis_video_TREADY_int_regslice_assign_proc : process(grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_start_fu_132_s_axis_video_TREADY, grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_152_s_axis_video_TREADY, grp_AXIvideo2MultiPixStream_Pipeline_loop_wait_for_eol_fu_180_s_axis_video_TREADY, ap_CS_fsm_state3, ap_CS_fsm_state6, ap_CS_fsm_state8)
    begin
    ...
    select_ln216_fu_351_p3 <= 
        grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_152_eol_out when (cmp10252_i_reg_449(0) = '1') else 
        axi_last_2_reg_122;
    xor_ln216_fu_273_p2 <= (cmp10252_i_fu_267_p2 xor ap_const_lv1_1);
end behav;
