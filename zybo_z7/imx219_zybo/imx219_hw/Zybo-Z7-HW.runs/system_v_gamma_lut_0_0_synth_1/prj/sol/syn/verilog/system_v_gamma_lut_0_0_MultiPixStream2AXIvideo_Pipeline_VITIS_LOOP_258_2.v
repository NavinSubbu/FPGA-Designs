...
always @ (*) begin
    ap_condition_173 = ((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln258_reg_193 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
assign axi_last_fu_165_p2 = ((sub_i_i_i == ap_sig_allocacmp_j_1) ? 1'b1 : 1'b0);

assign icmp_ln258_fu_153_p2 = ((ap_sig_allocacmp_j_1 == empty) ? 1'b1 : 1'b0);

assign j_2_fu_159_p2 = (ap_sig_allocacmp_j_1 + 12'd1);
