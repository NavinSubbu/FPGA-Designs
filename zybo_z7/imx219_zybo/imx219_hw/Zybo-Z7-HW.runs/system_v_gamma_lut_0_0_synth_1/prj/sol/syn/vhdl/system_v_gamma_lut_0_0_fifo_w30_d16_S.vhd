...
architecture rtl of system_v_gamma_lut_0_0_fifo_w30_d16_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component system_v_gamma_lut_0_0_fifo_w30_d16_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 30;
        ADDR_WIDTH : integer := 4;
        DEPTH      : integer := 16);
...
begin
----------------------- Instantiation -----------------------
    U_system_v_gamma_lut_0_0_fifo_w30_d16_S_ShiftReg : system_v_gamma_lut_0_0_fifo_w30_d16_S_ShiftReg
    generic map (
...
architecture rtl of system_v_gamma_lut_0_0_fifo_w30_d16_S_ShiftReg is
