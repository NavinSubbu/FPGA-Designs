...
HD_PWD='D:/FPGA/zybo/imx219/v2/pcam_hw/Zybo-Z7-HW.runs/system_v_gamma_lut_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_v_gamma_lut_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_v_gamma_lut_0_0.tcl
