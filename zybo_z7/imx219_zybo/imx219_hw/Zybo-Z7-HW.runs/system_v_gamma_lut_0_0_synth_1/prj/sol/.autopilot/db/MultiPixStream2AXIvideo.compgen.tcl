...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { imgGamma_dout { I 30 vector } imgGamma_empty_n { I 1 bit } imgGamma_read { O 1 bit } imgGamma_num_data_valid { I 5 vector } imgGamma_fifo_cap { I 5 vector } } \
} "
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler system_v_gamma_lut_0_0_regslice_both BINDTYPE {interface} TYPE {adapter} IMPL {reg_slice}
}
