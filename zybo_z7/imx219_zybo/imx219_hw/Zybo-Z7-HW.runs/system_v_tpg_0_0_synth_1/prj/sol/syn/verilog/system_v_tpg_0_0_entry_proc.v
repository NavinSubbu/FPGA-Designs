...
module system_v_tpg_0_0_entry_proc (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
        ...
        motionSpeed_val23,
        motionSpeed_val23_c7_din,
        motionSpeed_val23_c7_full_n,
        motionSpeed_val23_c7_write,
        motionSpeed_val23_c7_num_data_valid,
        motionSpeed_val23_c7_fifo_cap,
        crossHairX_val28,
...
output  [7:0] motionSpeed_val23_c7_din;
input   motionSpeed_val23_c7_full_n;
output   motionSpeed_val23_c7_write;
input  [2:0] motionSpeed_val23_c7_num_data_valid;
input  [2:0] motionSpeed_val23_c7_fifo_cap;
...
output  [9:0] boxColorR_val35_c_din;
...
output  [9:0] boxColorG_val36_c_din;
...
output  [9:0] boxColorB_val37_c_din;
...
reg motionSpeed_val23_c7_write;
...
reg    motionSpeed_val23_c7_blk_n;
...
always @ (*) begin
    if ((~((real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        motionSpeed_val23_c7_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
        motionSpeed_val23_c7_write = 1'b1;
    end else begin
        motionSpeed_val23_c7_write = 1'b0;
    end
end
...
assign motionSpeed_val23_c7_din = motionSpeed_val23;
...
endmodule //system_v_tpg_0_0_entry_proc
