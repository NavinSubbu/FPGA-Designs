...
HD_PWD='D:/FPGA/zybo/hdmi/hw/Zybo-Z7-HW.runs/design_1_axi_interconnect_hp0_imp_s00_regslice_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_interconnect_hp0_imp_s00_regslice_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_interconnect_hp0_imp_s00_regslice_0.tcl
