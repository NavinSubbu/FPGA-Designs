set SynModuleInfo {
  ...
  {SRCNAME AXIvideo2MultiPixStream MODELNAME AXIvideo2MultiPixStream RTLNAME system_v_gamma_lut_0_0_AXIvideo2MultiPixStream
    SUBMODULES {
      {MODELNAME system_v_gamma_lut_0_0_regslice_both RTLNAME system_v_gamma_lut_0_0_regslice_both BINDTYPE interface TYPE adapter IMPL reg_slice}
    }
  }
  ...
  {SRCNAME v_gamma_lut MODELNAME v_gamma_lut RTLNAME system_v_gamma_lut_0_0_v_gamma_lut IS_TOP 1
    SUBMODULES {
      {MODELNAME system_v_gamma_lut_0_0_fifo_w30_d16_S RTLNAME system_v_gamma_lut_0_0_fifo_w30_d16_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME imgRgb_U}
      {MODELNAME system_v_gamma_lut_0_0_fifo_w30_d16_S RTLNAME system_v_gamma_lut_0_0_fifo_w30_d16_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME imgGamma_U}
