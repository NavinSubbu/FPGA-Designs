...
architecture behav of system_v_gamma_lut_0_0_v_gamma_lut is 
    ...
    "system_v_gamma_lut_0_0_v_gamma_lut,hls_ip_2024_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010-clg400-1,HLS_INPUT_CLOCK=6.667000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=4.842000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=6,HLS_SYN_DSP=0,HLS_SYN_FF=1042,HLS_SYN_LUT=1506,HLS_VERSION=2024_2}";
    ...
    signal Gamma_U0_imgGamma_num_data_valid : STD_LOGIC_VECTOR (31 downto 0);
    signal Gamma_U0_imgGamma_fifo_cap : STD_LOGIC_VECTOR (31 downto 0);
    ...
    component system_v_gamma_lut_0_0_fifo_w30_d16_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
...
begin
    ...
    port map (
        ...
        imgGamma_num_data_valid => Gamma_U0_imgGamma_num_data_valid,
        imgGamma_fifo_cap => Gamma_U0_imgGamma_fifo_cap,
        width => width,
        height => height,
        gamma_lut_0_address0 => Gamma_U0_gamma_lut_0_address0,
        gamma_lut_0_ce0 => Gamma_U0_gamma_lut_0_ce0,
    ...
    imgRgb_U : component system_v_gamma_lut_0_0_fifo_w30_d16_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    imgGamma_U : component system_v_gamma_lut_0_0_fifo_w30_d16_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    Gamma_U0_imgGamma_fifo_cap <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(IEEE.numeric_std.resize(unsigned(imgGamma_fifo_cap),5))),32));
    Gamma_U0_imgGamma_num_data_valid <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(IEEE.numeric_std.resize(unsigned(imgGamma_num_data_valid),5))),32));
