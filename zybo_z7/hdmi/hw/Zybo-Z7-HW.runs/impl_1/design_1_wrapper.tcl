namespace eval ::optrace {
  variable script "D:/FPGA/zybo/hdmi/hw/Zybo-Z7-HW.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "create in-memory project" START { }
  ...
  set_property board_part_repo_paths {D:/FPGA/zybo/hdmi/hw/Zybo-Z7-HW.board} [current_project]
  set_property board_part digilentinc.com:zybo-z7-10:part0:1.1 [current_project]
  set_property design_mode GateLvl [current_fileset]
  set_param project.singleFileAddWarning.threshold 0
OPTRACE "create in-memory project" END { }
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir D:/FPGA/zybo/hdmi/hw/Zybo-Z7-HW.cache/wt [current_project]
  set_property parent.project_path D:/FPGA/zybo/hdmi/hw/Zybo-Z7-HW.xpr [current_project]
  set_property ip_repo_paths D:/FPGA/zybo/hdmi/hw/Zybo-Z7-HW.ipdefs/repo [current_project]
  update_ip_catalog
  set_property ip_output_repo D:/FPGA/zybo/hdmi/hw/Zybo-Z7-HW.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet D:/FPGA/zybo/hdmi/hw/Zybo-Z7-HW.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files D:/FPGA/zybo/hdmi/hw/Zybo-Z7-HW.srcs/sources_1/bd/design_1/design_1.bd
  set_param project.isImplRun false
OPTRACE "read constraints: implementation" START { }
  read_xdc D:/FPGA/zybo/hdmi/hw/Zybo-Z7-HW.srcs/constrs_1/imports/constraints/Zybo-Z7-Master.xdc
