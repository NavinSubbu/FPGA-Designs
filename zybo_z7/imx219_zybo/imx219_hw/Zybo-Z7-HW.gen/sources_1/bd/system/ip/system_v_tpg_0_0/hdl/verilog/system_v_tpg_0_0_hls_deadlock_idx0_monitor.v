...
module system_v_tpg_0_0_hls_deadlock_idx0_monitor ( // for module system_v_tpg_0_0_v_tpg_inst
    input wire clock,
    input wire reset,
...
// instant sub module
 system_v_tpg_0_0_hls_deadlock_idx1_monitor system_v_tpg_0_0_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
