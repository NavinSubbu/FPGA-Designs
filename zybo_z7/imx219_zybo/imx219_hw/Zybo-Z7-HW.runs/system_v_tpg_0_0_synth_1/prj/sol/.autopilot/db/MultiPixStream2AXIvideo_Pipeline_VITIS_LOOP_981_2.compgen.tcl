...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler system_v_tpg_0_0_sparsemux_7_2_11_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {onehotencoding_realdef}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler system_v_tpg_0_0_sparsemux_7_2_10_1_1_x BINDTYPE {op} TYPE {sparsemux} IMPL {onehotencoding_realdef}
}
...
eval "cg_default_interface_gen_dc { \
    id 321 \
    name counter_loc_0_i \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_counter_loc_0_i \
    op interface \
    ports { counter_loc_0_i { I 16 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sub_cast_i \
    op interface \
    ports { sub_cast_i { I 13 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { counter_loc_1_i_out { O 16 vector } counter_loc_1_i_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_phi_ln1036_out \
    op interface \
    ports { phi_ln1036_out { O 1 vector } phi_ln1036_out_ap_vld { O 1 bit } } \
} "
}
