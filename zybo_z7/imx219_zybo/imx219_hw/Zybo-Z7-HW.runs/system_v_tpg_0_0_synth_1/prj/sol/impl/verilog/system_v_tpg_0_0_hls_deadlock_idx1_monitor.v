...
module system_v_tpg_0_0_hls_deadlock_idx1_monitor ( // for module system_v_tpg_0_0_v_tpg_inst.grp_v_tpgHlsDataFlow_fu_505
    input wire clock,
    input wire reset,
...
assign process_axis_block_vec[4] = idx6_block & (1'b0 | axis_block_sigs[3]);
...
// instant sub module
 system_v_tpg_0_0_hls_deadlock_idx2_monitor system_v_tpg_0_0_hls_deadlock_idx2_monitor_U (
    .clock(clock),
    .reset(reset),
