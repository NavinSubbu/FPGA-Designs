...
dict set ap_memory_interface_dict lut_1 { MEM_WIDTH 10 MEM_SIZE 2048 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict lut_2 { MEM_WIDTH 10 MEM_SIZE 2048 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict lut_0 { MEM_WIDTH 10 MEM_SIZE 2048 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
...
set portList { 
	...
	{ imgGamma_num_data_valid sc_in sc_lv 32 signal 5 } 
	{ imgGamma_fifo_cap sc_in sc_lv 32 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "imgGamma_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "imgGamma", "role": "num_data_valid" }} , 
 	{ "name": "imgGamma_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "imgGamma", "role": "fifo_cap" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "69", "Max" : "3845"}
	, {"Name" : "Interval", "Min" : "69", "Max" : "3845"}
]}
...
set Spec2ImplPortList { 
	...
	imgRgb { ap_fifo {  { imgRgb_dout fifo_data_in 0 30 }  { imgRgb_empty_n fifo_status 0 1 }  { imgRgb_read fifo_port_we 1 1 }  { imgRgb_num_data_valid fifo_status_num_data_valid 0 5 }  { imgRgb_fifo_cap fifo_update 0 5 } } }
	...
	imgGamma { ap_fifo {  { imgGamma_din fifo_data_in 1 30 }  { imgGamma_full_n fifo_status 0 1 }  { imgGamma_write fifo_port_we 1 1 }  { imgGamma_num_data_valid fifo_status_num_data_valid 0 32 }  { imgGamma_fifo_cap fifo_update 0 32 } } }
}
