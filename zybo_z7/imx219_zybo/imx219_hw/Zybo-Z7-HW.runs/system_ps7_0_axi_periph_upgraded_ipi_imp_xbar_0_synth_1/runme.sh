...
HD_PWD='D:/FPGA/zybo/pcam_hw/Zybo-Z7-HW.runs/system_ps7_0_axi_periph_upgraded_ipi_imp_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_ps7_0_axi_periph_upgraded_ipi_imp_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_ps7_0_axi_periph_upgraded_ipi_imp_xbar_0.tcl
