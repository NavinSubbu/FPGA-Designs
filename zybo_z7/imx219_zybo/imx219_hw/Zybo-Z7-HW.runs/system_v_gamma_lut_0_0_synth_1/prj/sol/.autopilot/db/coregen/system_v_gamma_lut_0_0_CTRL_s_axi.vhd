...
end entity system_v_gamma_lut_0_0_CTRL_s_axi;
...
architecture behave of system_v_gamma_lut_0_0_CTRL_s_axi is
    ...
    component system_v_gamma_lut_0_0_CTRL_s_axi_ram is
        generic (
    ...
    end component system_v_gamma_lut_0_0_CTRL_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_gamma_lut_0
int_gamma_lut_0 : system_v_gamma_lut_0_0_CTRL_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
-- int_gamma_lut_1
int_gamma_lut_1 : system_v_gamma_lut_0_0_CTRL_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
-- int_gamma_lut_2
int_gamma_lut_2 : system_v_gamma_lut_0_0_CTRL_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
end entity system_v_gamma_lut_0_0_CTRL_s_axi_ram;

architecture behave of system_v_gamma_lut_0_0_CTRL_s_axi_ram is
